...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['save'])) {
    ...
    try {
        ...
        $stmt->execute([$supplier_name, $order_date, $tin, $delivery_date, $payment_terms, $sub_total, $discount, $total, $document_path]);
        $order_id = $conn->lastInsertId();

        // Insert order items into SupplierOrderItems
        ...
        $conn->rollBack();
        echo "<script>alert` alert('Error saving order: " . addslashes($e->getMessage()) . "');</script>";
    }
}
?>
...
<head>
    ...
    <link href="../statics/NewCustomerOrder.css" rel="stylesheet"> <!-- Assuming this CSS can be reused -->
...
<div class="container">
    ...
    <form method="post" idptides supplierOrderForm" enctype="multipart/form-data">
        <div class="row mb-3">
            <div class="col-md-6">
